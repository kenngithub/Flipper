    ...
    public class Flipper
    {
        ...
        public async Task Login()
        {
            try
            {
                ...
                var loginResponse = await futClient.LoginAsync(loginDetails[Account].LoginDetails, new TwoFactorCodeEmailProvider(loginDetails[Account].LoginDetails.Username, loginDetails[Account].LoginDetails.Password, Log));
                SetupGoogle();
        ...
        {
            var twoFactorCodeProvider = new TwoFactorCodeEmailProvider(loginDetails[Account].LoginDetails.Username, loginDetails[Account].LoginDetails.Password, Log);
